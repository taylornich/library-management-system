...
def view_genre_details():
    ...
    if name in genres:
        genre = genres[name]
        print(f"Genre details: Name: {genre.get_genre_name()}, Description: {genre.get_description()}, Category: {genre.get_category()}")
    else:
...
def display_genres():
    if genres:
        for genre in genres.values():
            print(f"Name: {genre.get_genre_name()}, Description: {genre.get_description}, Category: {genre.get_category()}")
    else: 
